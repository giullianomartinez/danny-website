LANDING = {
    ...
    "services": [
        {
            ...
            "body": (
                "La música se prepara antes del evento y se ajusta en vivo según "
                "lo que vaya pidiendo la pista."
            ),
        },
        {
            "signal": "Corte",
    ...
    "packages": [
        ...
        },
        {
            ...
            "price": "A medida",
            "fit": "Para marcas, lanzamientos y presentaciones con pantalla.",
            "items": [
                "Visuales en vivo",
